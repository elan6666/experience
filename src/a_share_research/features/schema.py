...
_D0_FEATURES = (
    ...
    # --- A-share broad index factors (enriched S group) ---
    _f(
        "idx_000001_trend_20d",
        _STATE,
        _STATE_GROUP,
        _SHARED_STATE,
        "idx_000001_trend_20d",
