...
- 生成时间: 2026-07-20
- 范围: 六模型（Ridge / LightGBM / iTransformer / FACT / TimePro / TimeXer）× 三 universe（CSI300 / TECH32 / TECH90），STAR50 因 D0 成分股缺失被 gate 阻断，S4M 延后至 FTR-001
...
| 模型 | csi300 IC | tech32 IC | tech90 IC | 判定 |
|------|----------|----------|------------|------|
...
- 9 cell 中 7 个 `best_epoch=1, epochs_completed=4`；tech90 s21 `best_epoch=2`；仅 csi300 s21 `best_epoch=20`。
...
| timexer | tech90 | 19 | -0.0213 | 0.497 | 24 | 0.0281 | V | 43570ae754be |
| timexer | tech90 | 20 | +0.0470 | 0.505 | 23 | 0.0601 | V | ebb9e1671fe0 |
| timexer | tech90 | 21 | -0.0175 | 0.498 | 19 | 0.0455 | V | 3a61dc44f86b |
...
| fact | tech90 | 19 | -0.0267 | 0.490 | 12 | 0.0751 | VN | f9f4187775ad |
| fact | tech90 | 20 | -0.0155 | 0.503 | 3 | 0.0339 | VN | 71761baa19d4 |
| fact | tech90 | 21 | -0.0212 | 0.493 | 17 | 0.0132 | VN | 51af7f0a9477 |
...
| timepro | tech90 | 19 | +0.0059 | 0.503 | 25 | 0.0180 | VN | d0bec9fd6853 |
| timepro | tech90 | 20 | +0.0008 | 0.501 | 5 | 0.0366 | VN | b15105256777 |
| timepro | tech90 | 21 | -0.0189 | 0.491 | 1 | 0.0114 | VN | 95cde7f2619a |
...
| itransformer | tech90 | 19 | -0.0343 | 0.481 | 1 | 0.0447 | FC | 8bec1ce4f568 |
| itransformer | tech90 | 20 | -0.0237 | 0.503 | 1 | 0.1292 | FC | 0eca648ea62e |
| itransformer | tech90 | 21 | +0.0172 | 0.506 | 2 | 0.0450 | FC | 14902592d2ca |

注: itransformer tech32 s21 与 tech90 s21 虽 IC 为正，但 best_epoch=1/2、epochs_done=4/5，仍归 FC（未充分收敛），正 IC 不可作为定论。
